...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Okt 2024 pada 03.51
-- Versi server: 8.0.36
-- Versi PHP: 8.2.12
...
CREATE TABLE `user` (
  ...
  `email_user` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `user` (`id_user`, `password_user`, `Role`, `nama_user`, `email_user`, `nomor_hp`) VALUES
(1, 'perkasa23@rcm', 'admin', 'abi_bayu', 'abibayu83@gmail.com', '081222965873');
...
--
ALTER TABLE `tanaman`
  MODIFY `id_tanaman` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
